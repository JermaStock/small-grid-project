...
/* harmony import */ var _components_fix_fullheight_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/fix-fullheight.js */ "./src/js/components/fix-fullheight.js");
/* harmony import */ var _components_menu_height_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/menu-height.js */ "./src/js/components/menu-height.js");
/* harmony import */ var _components_validate_form_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/validate-form.js */ "./src/js/components/validate-form.js");
/* harmony import */ var _components_contacts_show_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/contacts-show.js */ "./src/js/components/contacts-show.js");
/* harmony import */ var _components_ymap_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/ymap.js */ "./src/js/components/ymap.js");
/* harmony import */ var _components_ymap_js__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_components_ymap_js__WEBPACK_IMPORTED_MODULE_6__);
...
/***/ "./src/js/components/contacts-show.js":
/*!********************************************!*\
  !*** ./src/js/components/contacts-show.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((function contactsShow() {
  const contactsField = document.querySelector(".location");
  const contactsFieldLocation = document.querySelector(".location__street");
  contactsField.addEventListener('click', e => {
    if (e.target.classList.contains("location__close") || e.target.closest('.location__close')) {
      contactsFieldLocation.classList.add('overflow-hide');
    }
    if (e.target.classList.contains("location__open") || e.target.closest('.location__open')) {
      contactsFieldLocation.classList.remove('overflow-hide');
    }
  });
})());
...
/***/ "./src/js/components/fix-fullheight.js":
/*!*********************************************!*\
  !*** ./src/js/components/fix-fullheight.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let fixHeight = (0,_functions_throttle__WEBPACK_IMPORTED_MODULE_0__.throttle)(fixFullheight);
fixHeight();
window.addEventListener('resize', fixHeight);

/***/ }),

/***/ "./src/js/components/menu-height.js":
/*!******************************************!*\
  !*** ./src/js/components/menu-height.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const menuHeight = () => {
  const height = document.querySelector('.header__nav').offsetHeight;
  document.querySelector(':root').style.setProperty('--header-menu-height', `${height}px`);
};
let fixHeight = (0,_functions_throttle__WEBPACK_IMPORTED_MODULE_0__.throttle)(menuHeight);
fixHeight();
window.addEventListener('resize', fixHeight);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((function () {
  ...
  search.addEventListener('click', e => {
    if (e.target.classList.contains("search__btn") || e.target.closest('.search__btn')) {
      search.querySelector('.search__input').value = '';
      search.querySelector('.search__bar').classList.add('search__bar--active');
      e._isSearchBarOpen = true;
    } else if (e.target.classList.contains("search__close") || e.target.closest('.search__close')) {
      search.querySelector('.search__bar').classList.remove('search__bar--active');
    }
    e._isClickWithinSearchBar = true;
  });
  searchForm.addEventListener('submit', e => {
    e.preventDefault();
  });
  window.addEventListener('click', e => {
    if (e._isClickWithinSearchBar) return;
    search.querySelector('.search__bar').classList.remove('search__bar--active');
  });
})());
...
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.application__form', contactsRules);
(0,_functions_validate_forms_js__WEBPACK_IMPORTED_MODULE_0__.validateForms)('.subscribe__form', aboutRules);
...
let center = [55.764679419786255, 37.62812178328897];
function init() {
  ...
  var placemark = new ymaps.Placemark([55.77100502279006, 37.63474331712723], {}, {
...
loaderWrapper.style.cssText = "width: 100%; height: 100%; display: flex; justify-content: center; align-items: center";
loader.classList.add("loader");
loaderWrapper.append(loader);
loaderWrapper.append;
locationMap.append(loaderWrapper);
ymaps.ready(init);
...
const validateForms = (selector, rules, afterSend) => {
  ...
  const validation = new just_validate__WEBPACK_IMPORTED_MODULE_0__["default"](selector, {
    ...
    errorFieldCssClass: 'input-error-field'
  });
  for (let item of rules) {
